...
- For image prompts, the seller's own main product reference image controls product appearance. Competitor links are only for module/storyboard inspiration. Do not repeat the sentence "Use the uploaded product photo as the exact product reference".
...
- Every image prompt must include concise sections inside the prompt text: Product appearance, Reference inspiration, Originality guardrail, Composition, On-image text.
  ...
  "image_prompts": [
    {
      ...
      "prompt_en": "English image-generation prompt. Must be generated by the selected model, not a generic template. Include Product appearance, Reference inspiration, Originality guardrail, Composition, On-image text.",
      "prompt_cn": "Chinese explanation prompt. Explain why this prompt fits the seller product and competitor reference direction.",
